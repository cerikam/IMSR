# ******************************************************************************************
#
#                       EIRENE Write Refuel Salt Atom Density
#       
#   Purpose: Calculates the atom density values for a specified refuel salt amount and 
#            enrichment level. Use this script with write_burend_salt.py and mix_salt.py
#            to create a new fuel salt material composition for the refuel salt mixed in   
#            with the burned salt.
#
# *******************************************************************************************
...
def add_refuel_to_core(refuel_amount):
