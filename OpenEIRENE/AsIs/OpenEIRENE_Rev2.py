...
fuel = openmc.Material(name='fuel', temperature=923.15)
fuel.add_nuclide('Li6', 8.095081432923162e-06, 'wo')
fuel.add_nuclide('Li7', 0.09441110465090366, 'wo')
fuel.add_nuclide('Be9', 0.06064340586404249, 'wo')
fuel.add_nuclide('F19', 0.5921015057314345, 'wo')
fuel.add_nuclide('U234', 5.8646810581877845e-05, 'wo')
fuel.add_nuclide('U235', 0.0066177685742261575, 'wo')
fuel.add_nuclide('U236', 3.057146176919094e-05, 'wo')
fuel.add_nuclide('U238', 0.24612890182560904, 'wo')
fuel.set_density('g/cm3', 2.549170524299325)
...
#materials.cross_sections = '/home/sigma/OpenMC/CrossSections/endfb80/endfb-viii.0-hdf5/cross_sections.xml'

materials.cross_sections = '/home/sigma/OpenMC/CrossSections/jeff33/jeff-3.3-hdf5/cross_sections.xml'

#materials.cross_sections = '/home/sigma/OpenMC/CrossSections/mcnp_endfb70/cross_sections.xml'

#materials.cross_sections = '/home/sigma/OpenMC/CrossSections/mcnp_endfb70/cross_sections.xml'

#materials.cross_sections = '/home/sigma/OpenMC/CrossSections/endfb71/endfb-vii.1-hdf5/cross_sections.xml'

#materials.cross_sections = '/home/sigma/OpenMC/CrossSections/nea_jeff33/jeff-3.3-hdf5/cross_sections.xml'
...
# Region 1 Fuel Channels:

top_corereg = openmc.ZPlane(z0=+415.0)
bottom_corereg = openmc.ZPlane(z0=-0.0)


r1_channel = openmc.ZCylinder(r=1.157)
fuel_cell = openmc.Cell(fill=fuel, region=-r1_channel & +bottom_corereg & -top_corereg)
graphite_cell = openmc.Cell(fill=graphite, region=+r1_channel & +bottom_corereg & -top_corereg)
r1_channel_universe = openmc.Universe(cells=(fuel_cell, graphite_cell))
...
r2_channel = openmc.ZCylinder(r=1.2197)
r2_fuel_cell = openmc.Cell(fill=fuel, region=-r2_channel & +bottom_corereg & -top_corereg)
r2_graphite_cell = openmc.Cell(fill=graphite, region=+r2_channel & +bottom_corereg & -top_corereg)
r2_channel_universe = openmc.Universe(cells=(r2_fuel_cell, r2_graphite_cell))
...
r3_channel = openmc.ZCylinder(r=1.3485)
r3_fuel_cell = openmc.Cell(fill=fuel, region=-r3_channel & +bottom_corereg & -top_corereg)
r3_graphite_cell = openmc.Cell(fill=graphite, region=+r3_channel & +bottom_corereg & -top_corereg)
r3_channel_universe = openmc.Universe(cells=(r3_fuel_cell, r3_graphite_cell))
...
#top_corereg = openmc.ZPlane(z0=+415.0, boundary_type='vacuum')
#bottom_corereg = openmc.ZPlane(z0=-0.0, boundary_type='vacuum')
...
# NOTE: Change these to be appropriate for EIRENE!
...
#settings_file.create_fission_neutrons = True
...
#lower_left = [-200, -200, -15.5]
#upper_right = [300, 300, 565]
