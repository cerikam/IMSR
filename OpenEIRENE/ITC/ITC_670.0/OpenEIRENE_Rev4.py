...
fuel = openmc.Material(name='fuel', temperature=943.15)
...
fuel.set_density('g/cm3', 2.5386837180490596)

# ----- Graphite: -----

graphite = openmc.Material(name='graphite', temperature=943.15)
...
hastelloy = openmc.Material(name='hastelloy', temperature=943.15)
...
helium = openmc.Material(name='helium', temperature=943.15)
...
ss316 = openmc.Material(name='ss316', temperature=943.15)
