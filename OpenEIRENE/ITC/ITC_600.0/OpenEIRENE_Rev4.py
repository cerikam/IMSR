...
fuel.set_density('g/cm3', 2.575388403130299)

# ----- Graphite: -----

graphite = openmc.Material(name='graphite', temperature=873.15)
...
hastelloy = openmc.Material(name='hastelloy', temperature=873.15)
...
ss316 = openmc.Material(name='ss316', temperature=873.15)
