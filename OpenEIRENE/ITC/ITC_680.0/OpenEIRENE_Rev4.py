...
fuel = openmc.Material(name='fuel', temperature=953.15)
fuel.add_nuclide('Li6', 0.0000080950813339628, 'wo')
fuel.add_nuclide('Li7', 0.0944111081717932954, 'wo')
fuel.add_nuclide('Be9', 0.0606434022134818840, 'wo')
fuel.add_nuclide('F19', 0.5921015159894703617, 'wo')
fuel.add_nuclide('U234', 0.0000586468129798191, 'wo')
fuel.add_nuclide('U235', 0.0066177686246662063, 'wo')
fuel.add_nuclide('U236', 0.0000305714610861125, 'wo')
fuel.add_nuclide('U238', 0.2461288916451881692, 'wo')
fuel.set_density('g/cm3', 2.5334401502769106)

# ----- Graphite: -----

graphite = openmc.Material(name='graphite', temperature=953.15)
...
hastelloy = openmc.Material(name='hastelloy', temperature=953.15)
...
helium = openmc.Material(name='helium', temperature=953.15)
...
ss316 = openmc.Material(name='ss316', temperature=953.15)
