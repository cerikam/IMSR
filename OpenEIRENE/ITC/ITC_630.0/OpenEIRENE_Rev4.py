...
fuel = openmc.Material(name='fuel', temperature=903.15)
...
fuel.set_density('g/cm3', 2.5596578251175024)

# ----- Graphite: -----

graphite = openmc.Material(name='graphite', temperature=903.15)
...
hastelloy = openmc.Material(name='hastelloy', temperature=903.15)
...
helium = openmc.Material(name='helium', temperature=903.15)
...
ss316 = openmc.Material(name='ss316', temperature=903.15)
