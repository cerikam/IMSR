...
fuel = openmc.Material(name='fuel', temperature=933.15)
...
fuel.set_density('g/cm3', 2.5439271808036765)

# ----- Graphite: -----

graphite = openmc.Material(name='graphite', temperature=933.15)
...
hastelloy = openmc.Material(name='hastelloy', temperature=933.15)
...
helium = openmc.Material(name='helium', temperature=933.15)
...
ss316 = openmc.Material(name='ss316', temperature=933.15)
