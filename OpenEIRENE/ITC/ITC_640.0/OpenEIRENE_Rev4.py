...
fuel = openmc.Material(name='fuel', temperature=913.15)
...
fuel.set_density('g/cm3', 2.5544141988208726)

# ----- Graphite: -----

graphite = openmc.Material(name='graphite', temperature=913.15)
...
hastelloy = openmc.Material(name='hastelloy', temperature=913.15)
...
helium = openmc.Material(name='helium', temperature=913.15)
...
ss316 = openmc.Material(name='ss316', temperature=913.15)
