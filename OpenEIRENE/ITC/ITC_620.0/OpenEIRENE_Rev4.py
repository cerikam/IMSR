...
fuel = openmc.Material(name='fuel', temperature=893.15)
...
fuel.set_density('g/cm3', 2.56490138513199)

# ----- Graphite: -----

graphite = openmc.Material(name='graphite', temperature=893.15)
...
hastelloy = openmc.Material(name='hastelloy', temperature=893.15)
...
helium = openmc.Material(name='helium', temperature=893.15)
...
ss316 = openmc.Material(name='ss316', temperature=893.15)
