...
graphite = openmc.Material(name='graphite', temperature=973.15)
...
hastelloy = openmc.Material(name='hastelloy', temperature=973.15)
...
helium = openmc.Material(name='helium', temperature=973.15)
...
ss316 = openmc.Material(name='ss316', temperature=973.15)
