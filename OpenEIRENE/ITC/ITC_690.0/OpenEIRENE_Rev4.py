...
fuel = openmc.Material(name='fuel', temperature=963.15)
...
fuel.set_density('g/cm3', 2.528196888146428)

# ----- Graphite: -----

graphite = openmc.Material(name='graphite', temperature=963.15)
...
hastelloy = openmc.Material(name='hastelloy', temperature=963.15)
...
helium = openmc.Material(name='helium', temperature=963.15)
...
ss316 = openmc.Material(name='ss316', temperature=963.15)
