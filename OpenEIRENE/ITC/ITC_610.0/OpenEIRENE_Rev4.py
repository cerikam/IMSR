...
fuel = openmc.Material(name='fuel', temperature=883.15)
...
fuel.set_density('g/cm3', 2.5701449389557807)

# ----- Graphite: -----

graphite = openmc.Material(name='graphite', temperature=883.15)
...
hastelloy = openmc.Material(name='hastelloy', temperature=883.15)
...
helium = openmc.Material(name='helium', temperature=883.15)
...
ss316 = openmc.Material(name='ss316', temperature=883.15)
